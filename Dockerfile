...
RUN apt-get install -y apache2 php5 php5-gd php-xml-parser php5-intl php5-mysqlnd php5-json php5-mcrypt php-apc smbclient curl libcurl3 php5-curl bzip2 wget openssl php5-apcu
RUN apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*

# Install Owncloud
RUN curl -k https://download.owncloud.org/community/owncloud-8.1.8.tar.bz2 | tar jx -C /var/www/ && \
